            ...
            <div className="bg-white dark:bg-[#232427] rounded-lg p-6 space-y-6 text-gray-600 dark:text-gray-300">
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>We are not your broker, advisor, or fiduciary</li>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>Not be located in prohibited jurisdictions (including but not limited to: North Korea, Iran, Cuba, Syria, Russia)</li>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>You retain rights to your trading data</li>
                        <li>No right to copy, modify, or reverse engineer our platform</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>All activity from your account</li>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>Access platform through unauthorized means</li>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>Implement trading restrictions</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>Our total aggregate liability shall be limited to the maximum extent permitted by applicable law</li>
                        <li>We are not liable for any indirect, incidental, special, consequential, or punitive damages</li>
                        <li>We are not liable for any blockchain network, technical, or system issues beyond our control</li>
                    </ul>
                    <p className="mt-2">These limitations do not apply to liability arising from:</p>
                    <ul className="list-disc pl-6 space-y-1">
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>Your regulatory violations</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>One-year limitation period</li>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>Exclusive jurisdiction in Delaware courts</li>
                    </ul>
                </section>
